...
%
%  See also: robotics.slcore.internal.sim.PreferenceProfile
    ...
    methods
        ...
        function profile = getProfile(obj)
            if obj.ProfileMap.isKey(obj.ProfileName)
                ...
                assert(isa(profile, 'robotics.slcore.internal.sim.PreferenceProfile'));
            else
        ...
        function setProfile(obj, profile)
            validateattributes(profile, {'robotics.slcore.internal.sim.PreferenceProfile'}, {'scalar'});
            profile.ProfileName = obj.ProfileName;
    ...
    methods (Access=private)
        ...
        function prefs = loadPrefs(obj)
            ...
            for i=1:numel(profileStructs)
                s = profileStructs{i};
                prefs(s.ProfileName) = ...
                    robotics.slcore.internal.sim.PreferenceProfile.setPropsStruct(s, obj.getDefaultProfile());
            end
        end
